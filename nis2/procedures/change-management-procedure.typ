#set document(title: "Change Management Procedure", author: "[ORGANIZATION]")
#set page(
  paper: "a4",
  ...
  header: [
    ...
    #grid(
      ...
      align(right)[Change Management Procedure]
    )
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{#text(fill: rgb("nis2blue"))[*Change Management Procedure*]}
...
\begin{titlepage}
    \centering
    \vspace*{2cm}
    {\Huge\bfseries#text(fill: rgb("nis2blue"))[Change Management Procedure]\par}
    #v(0.5cm)

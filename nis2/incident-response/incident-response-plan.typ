#set document(title: "Incident Response Plan", author: "[ORGANIZATION]")
#set page(
  paper: "a4",
  ...
  header: [
    ...
    #grid(
      ...
      align(right)[Incident Response Plan]
    )
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{#text(fill: rgb("nis2blue"))[*Incident Response Plan*]}
...
\begin{titlepage}
    ...
    {\Huge\bfseries#text(fill: rgb("nis2blue"))[Incident Response Plan]\par}
    #v(0.5cm)
    ...
    {\large*Classification:* #text(fill: rgb("nis2red"))[CONFIDENTIAL]\par}
    \vfill
...
\rowcolor{nis2red} #text(fill: rgb("white"))[*Critical*] &
#text(fill: rgb("white"))[Complete service disruption, data breach affecting sensitive data, ransomware encryption of critical systems, nation-state attack] ,

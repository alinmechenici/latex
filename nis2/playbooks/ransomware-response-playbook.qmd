...
format:
  pdf:
    ...
    header-includes: |
      ...
      \fancyhead[R]{Ransomware Response Playbook}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textcolor{nis2blue}{**Ransomware Response Playbook**}}
...
\begin{titlepage}
    ...
    \textcolor{nis2red}{\Large**DO NOT DELAY - EVERY MINUTE COUNTS**}
    \vfill

...
format:
  pdf:
    ...
    header-includes: |
      ...
      \fancyhead[R]{Data Classification Policy}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textcolor{nis2blue}{**Data Classification Policy**}}
...
\rowcolor{critical} \textcolor{white}{**CRITICAL**} &
\textcolor{white}{**Highly sensitive data requiring maximum protection**} \\
...
\rowcolor{public} \textcolor{white}{**PUBLIC**} &
\textcolor{white}{**Publicly available information**} \\
